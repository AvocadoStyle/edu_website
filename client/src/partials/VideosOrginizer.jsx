  ...
  return (
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
        ...
        {/* Hero content */}
        <div className="relative pt-2 pb-10 md:pt-5 md:pb-2">
          {/* Section header */}
          {/* <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <p className="text-xl text-gray-400 mb-8" data-aos="fade-up" data-aos-delay="200">
              אתם תמצאו באתר זה סרטונים, מדריכים, וכלים שיעזרו לכם בחוויה הלימודית. הסרטונים הם עבור החומר
              של האוניברסיטה הפתוחה ברובו אבל הוא תקף לכל מוסד לימודי שהוא, או לכאלה שרוצים ללמוד ללא מוסד לימודי. 
              בנוסף אנחנו בונים פרוייקטים עבור חברות, וגם עבור אנשים פרטיים כגון דפי נחיתה ועוד כל מיני דפי ניהול מוצרים, ועוד
          ...
          <div className="">
            <div className="relative flex justify-center items-center" data-aos="fade-up" data-aos-delay="200">
              <img className="mx-auto" src={vid.img} width="550" height="50" alt="Hero" />
              <a
            ...
            <Modal id="modal" ariaLabel="modal-headline" show={videoModalOpen} handleClose={() => setVideoModalOpen(false)}>
              <div className="relative pb-9/16">
                <iframe className="absolute w-full h-full" src={vid.video_url_front_href} title="Video" allowFullScreen></iframe>
              </div>
            </Modal>
...
export default VideosOrginizer;
